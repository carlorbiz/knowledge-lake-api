...
function generateModuleContent(moduleRow, researchData) {
  try {
    ...
    // Step 2: Generate workbook (formerly Step 3)
    ...
    // Step 3: Generate assessments (formerly Step 5)
    ...
    // Step 4: Write to Master Workbook Audio tab (formerly Step 6)
    ...
    // Step 5: Write to Module Content Complete (formerly Step 7)
    ...
    // Step 6: Update Module Queue status (formerly Step 7)
