/**
 * COURSE CREATION WIZARD FOR CONCEPT-TO-COURSE
 * Guides configured users through the complete course development workflow
 * with intelligent progress tracking and contextual assistance
 */
...
function executeStep6_Slides_(courseContext) {
  ...
  ui.alert(
    ...
    '• Uses your configured Google Slides template\n' +
    '• Creates 12 slides with professional content\n' +
    '• Choice of detailed or executive summary formats\n' +
    '• Organised storage in appropriate module folder\n' +
    '• Ready for instructor-led or self-paced delivery\n\n' +
  ...
  ui.alert(
    ...
    '2. From the menu, select: Concept-to-Course → SLIDES & AUDIO → #6 Generate Slides for Module\n' +
  ...
  ui.alert(
    ...
    '• Clear, readable content on each slide\n' +
    '• Logical progression from slide to slide\n' +
    '• Appropriate level of detail for your audience\n\n' +
  ...
  const step6Complete = ui.alert(
    ...
    '✓ Professional 12-slide presentation created\n' +
    '✓ Template branding applied consistently\n' +
    '✓ Content optimised for your chosen format\n' +
    '✓ Organised in appropriate Drive folder\n\n' +
    'WHAT HAPPENS NEXT:\n' +
...
function executeStep7_Voice_(courseContext) {
  ...
  const skipVoice = ui.alert(
    ...
    '• Choose from 6 professional Australian voices\n' +
    '• Apply consistent voice across all modules\n' +
    '• Personalise your course audio branding\n\n' +
  ...
  if (skipVoice === ui.Button.YES) {
    ui.alert(
      ...
      'WHAT TO DO NOW:\n' +
      '1. From the menu, select: Concept-to-Course → SLIDES & AUDIO → #7 Set Voiceover Artist\n' +
      ...
      'VOICE OPTIONS:\n' +
      '• Schedar: Female, even, professional (default)\n' +
      '• Vindemiatrix: Female, gentle\n' +
      '• Gacrux: Female, mature authority\n' +
      '• Puck: Male, upbeat, engaging\n' +
      '• Charon: Male, informative, deep\n' +
      '• Orus: Male, firm, authoritative\n\n' +
      'Click OK, then run the menu function.',
      ui.ButtonSet.OK
    );
  ...
  const step7Complete = ui.alert(
    ...
    '✓ Professional voice selected for audio narration\n' +
    '✓ Consistent branding across all modules\n' +
    '✓ Australian professional delivery ensured\n\n' +
    'WHAT HAPPENS NEXT:\n' +
...
function executeStep8_Audio_(courseContext) {
  ...
  ui.alert(
    ...
    '• Executive-level narration scripts for each slide\n' +
    '• High-quality AI voice with Australian professional delivery\n' +
    '• WAV audio files organised in your module folder\n' +
    '• Ready for LMS integration or presentation use\n\n' +
  ...
  ui.alert(
    ...
    'WHAT TO DO NOW:\n' +
    '1. Ensure you\'re on the same module row\n' +
    '2. From the menu, select: Concept-to-Course → SLIDES & AUDIO → #8 Generate All Audio for Module\n' +
    '3. Wait for audio generation (this takes 20-30 minutes)\n' +
    '4. Monitor progress through toast notifications\n\n' +
    'WHAT WILL BE CREATED:\n' +
    '• Professional voiceover script for each slide (12 total)\n' +
    '• High-quality WAV audio files\n' +
    '• Executive-level delivery suitable for senior professionals\n' +
    '• Organised file storage with systematic naming\n\n' +
    'Click OK, then run the menu function.',
    ui.ButtonSet.OK
  );
  ...
  ui.alert(
    ...
    '• Executive-level tone and authority\n\n' +
  ...
  const moduleComplete = ui.alert(
    ...
    '✓ Professional content suite generated\n' +
    '✓ LMS-ready content package created\n' +
    '✓ Presentation slides with professional design\n' +
    '✓ High-quality audio narration completed\n\n' +
...
function executeStep9_Maintenance_(courseContext) {
  ...
  const needsMaintenance = ui.alert(
    ...
    '• Clean outdated audio files\n' +
    '• Remove superseded versions\n' +
    '• Maintain folder organisation\n' +
    '• Prepare for final course completion\n\n' +
  ...
  if (needsMaintenance === ui.Button.YES) {
    ui.alert(
      ...
      '2. From the menu, select: Concept-to-Course → DATA & ARCHIVAL → #9 Clean Module Audio Files\n' +
      '3. Confirm the cleanup when prompted\n\n' +
      'WHAT WILL BE CLEANED:\n' +
      '• Outdated audio files moved to trash\n' +
      '• Audio links cleared from tracking sheets\n' +
      '• Clean workspace for fresh generation if needed\n\n' +
...
function executeStep10_Archive_(courseContext) {
  ...
  const readyToComplete = ui.alert(
    ...
    '• Archive all course materials for long-term storage\n' +
    '• Create comprehensive backup spreadsheet\n' +
    '• Clean main workspace for new course development\n' +
  ...
  ui.alert(
    ...
    '2. From the menu, select: Concept-to-Course → DATA & ARCHIVAL → #10 Archive Course Project\n' +
    '3. Confirm archival when prompted\n\n' +
    'WHAT WILL BE CREATED:\n' +
    '• Complete backup spreadsheet with all course content\n' +
    '• All materials preserved in your Drive project folder\n' +
    '• Clean workspace ready for your next course\n' +
    '• Professional archive suitable for delivery\n\n' +
  ...
  ui.alert(
    ...
    '✓ Complete course structure with 8-12 modules\n' +
    '✓ Professional content suite for each module\n' +
    '✓ LMS-ready content packages\n' +
    '✓ Professional slide presentations\n' +
    '✓ High-quality audio narration\n' +
    '✓ Comprehensive course archive\n\n' +
    'Your course materials are ready for:\n' +
    '• LMS upload and delivery\n' +
    '• Instructor-led training sessions\n' +
    '• Professional development programs\n' +
    '• Accreditation submissions\n\n' +
    'NEXT STEPS:\n' +
    '• Review final materials in your Drive folder\n' +
    '• Upload to your LMS or delivery platform\n' +
    '• Begin delivery to your professional audience\n\n' +
...
function addCourseWizardToMenu_() {
  ...
  ui.createMenu('🧙‍♂️ Course Wizard')
      .addItem('🚀 Start Course Creation Wizard', 'launchCourseCreationWizard')
      .addSeparator()
