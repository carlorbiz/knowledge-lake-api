/**
 * Australian Healthcare TTS Generator - FINAL VERSION
 ...
 *
 * Features:
 * - Dynamic Gemini voice selection (Charon, Orus, Kore, Aoede, etc.)
 * - Australian healthcare pronunciation guidelines
 * - L16 to WAV conversion with proper headers
 * - Advanced Drive service integration
 * - Professional audio generation for healthcare education
 *
 * Created: 2025-09-29
...
VOICE SELECTION (Available Gemini Voices):
Male Voices:
- Charon: Informative, lower pitch (default)
